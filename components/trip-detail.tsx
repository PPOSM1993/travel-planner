    ...
    return (
        <div className="container mx-auto px-4 py-8 space-y-8">
            ...
            <div className="bg-white p-6 shadow rounded-none flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div className="mt-4 md:mt-0">
                    <Link href={`/trips/${trip.id}/itinerary/new`}>
                        <Button className="bg-green-600 hover:bg-green-600 rounded-none text-white">
                            {" "}
            ...
            <div className="text-center">
                <Link href={`/trips`}>
                    <Button className="mx-auto bg-white bg-red-600 hover:bg-red-600 rounded-none text-gray-100">
